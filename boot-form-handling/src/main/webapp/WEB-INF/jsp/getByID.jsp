...
<body bgcolor="#CB8CE9" style="background-image:url(https://www.chroniclebooks.com/blog/wp-content/uploads/books-1.jpg)">
	<jsp:include page="menu.jsp" />
	<center>      
	<h3 style="color: red;">The publication with specified ID is</h3>
	<table border="2", class = "purpleHorizon" bordercolor = "red" ,bgcolor = "white">
